...
then
	...
	$HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/mapred/contrib/streaming/hadoop-0.21.0-streaming.jar -file $HERE/map.py -mapper $HERE/map.py -file $HERE/reduce.py -reducer $HERE/reduce.py -input testData -output testData-output
